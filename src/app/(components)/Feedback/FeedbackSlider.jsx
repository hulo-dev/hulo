...
const FEEDBACK_CLIENT = [
    ...
    },
    {
        ...
        description:'Working with hulo.dev has been to a crucial part of building my design practice and allowing me to offer my clients agency level websites.  Their custom coding skills for Squarespace are the best in the industry.',
        src_img:'f1.png'
    },
    {
        name:'Suzie Consoli',
        profession:'Founder of Lawson House',
        description:'I can’t recommend hulo enough. They are so wonderful to work with. Pavlo is never overwhelmed by my crazy requests and gives helpful guidance on improving the UX experience for our clients. Their communication is outstanding, and they consistently overdeliver. I am so grateful to have found hulo!',
        src_img:'f1.png'
    }
]
